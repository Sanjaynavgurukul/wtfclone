...
class GymCategoryScreene extends StatefulWidget {
  static const String routeName = '/gymCategoryScreen';

  const GymCategoryScreene({Key key}) : super(key: key);

  @override
  _GymCategoryScreenStatee createState() => _GymCategoryScreenStatee();
}

class _GymCategoryScreenStatee extends State<GymCategoryScreene>
