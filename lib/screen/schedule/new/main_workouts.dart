...
class _MainWorkoutState extends State<MainWorkout> {
  ...
  void callWorkouts({@required String date,
  ...
  Widget build(BuildContext context) {
    ...
    ModalRoute
        .of(context)
        .settings
        .arguments as MainWorkoutArgument;
            ...
            return Scaffold(
              ...
              body: DefaultTabController(
                ...
                child: NestedScrollView(
                    ...
                    body: user.myWorkoutSchedule == null || user.myWorkoutSchedule.data == null ||
                        user.myWorkoutSchedule.data.length == 0 ? Center(
                        child: Text("no Workout available")) :
                    ListView.builder(
                        itemCount: user.myWorkoutSchedule.data.length,
                        itemBuilder: (context, index) {
                          //Item
                          WorkoutScheduleData item = user.myWorkoutSchedule
                              .data[index];
