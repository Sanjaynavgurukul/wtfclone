...
class Api {
  ...
  static String currentVersion = '201';

  static String getGyms(String lat, String lng) =>
      'gym?status=active&lat=$lat&long=$lng';

  // static const String SEARCH_GYM = 'gym/search';
  static String SEARCH_GYM({String lat, String lng, String query}) =>
      'gym/nearestgym?lat=$lat&long=$lng&name=$query';
  ...
  static String getNearByGym(String lat, String lng, String type) =>
      'gym/nearestgym?lat=$lat&long=$lng&type=$type';

  static String sendOtpToGymOwner() => 'subscription/sendotp';

  static String verifyOtpToGymOwner(
          {String userId, String gymId, String otp}) =>
      'subscription/verify?user_id=$userId&gym_id=$gymId&otp=$otp';

  static String getGymDetailsById({String gymId, String lat, String lng}) =>
      'gym/getbyid?uid=$gymId&lat=$lat&long=$lng';

  static String getForceUpdate() => 'version/latest';

  static String fetchSessionDuration({String addOnId}) =>
      'session/addon?addon=$addOnId';

  static String checkCoupon({String coupon, String plan_type}) =>
      'offer/code?code=$coupon&type_id=$plan_type';
