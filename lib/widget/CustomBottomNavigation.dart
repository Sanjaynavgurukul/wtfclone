...
/// The [CustomBottomNavigation.items] definition.
class CustomBottomBarItem {
  CustomBottomBarItem({
    @required this.icon,
    @required this.title,
    this.activeBgColor = AppConstants.primaryColor,
    this.textAlign,
    this.inactiveBgColor,
    this.activeTextColor = Colors.white,
    this.inactiveTextColor = AppConstants.white,
  });
  ...
  /// The [icon] color defined when this item is selected. Defaults
  /// to [Colors.blue].
  final Color activeBgColor;

  /// The [icon] color defined when this item is not selected.
  final Color inactiveBgColor;

  /// The [title] color defined when this item is selected. Defaults
  /// to [Colors.blue].
  final Color activeTextColor;

  /// The [title] color defined when this item is not selected.
