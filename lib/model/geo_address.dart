...
//
//     final geoAddress = geoAddressFromJson(jsonString);

import 'dart:convert';

GeoAddress geoAddressFromJson(String str) =>
    GeoAddress.fromJson(json.decode(str));

String geoAddressToJson(GeoAddress data) => json.encode(data.toJson());
